...
import { animateWithGsapTimeline } from "../utils/animationGsap";
        ...
        <div className="flex flex-col items-center mt-5">
          ...
          <div className="mx-auto w-full">
            ...
            <div className="flex-center">
              <ul className='color-container px-4 py-4' style={{backgroundColor:'#42424570'}}>
                {models.map((item, i) => (
                  <li key={i} className="w-6 h-6 rounded-full mx-2 cursor-pointer" style={{ backgroundColor: item.color[0] }} onClick={() => setModel(item)} />
                ))}
              </ul>

              <button className='size-btn-container ml-3 p-1 gap-1' style={{backgroundColor:'#42424570'}}>
